...
public class SecurePwdDel implements ILockDataOperator {

    private final String TAG = "SecurePwdDel";
     ...
     */
    public SecurePwdDel(Activity activity, Device mDevice) {
    ...
    private void processCharacterChanged(Intent intent) {
        ...
        if (MyEntity.RX_SERVICE_UUID.equals(service) && MyEntity.TX_CHAR_UUID.equals(character)) {
            ...
            try{
                ...
                Log.d(TAG, "锁内数据删除成功:inputBuffer.size()"+inputBuffer.size());
